          ...
          <View className="flex-row flex-wrap gap-2">
            {SIZES.map((size) => (
              <TouchableOpacity
                ...
                className={`px-4 py-2 rounded-lg border ${selectedSize === size ? "bg-orange-600 border-orange-900" : "border-gray-200"
                  }`}
              >
          ...
          <View className="flex-row gap-2">
            {COLORS.map((color) => (
              <TouchableOpacity
                ...
                className={`w-8 h-8 rounded-full ${selectedColor === color ? "border-2 border-orange-600" : "border border-gray-200"
                  }`}
