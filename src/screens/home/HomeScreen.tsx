...
// Updated products with better data
const products = [
  { 
    id: 1, 
    ...
    rating: 4.8, 
    reviews: 120, 
    image: "https://iili.io/37eGE9R.jpg",
    isFeatured: true,
    isNew: false,
    description: "Energy-efficient lighting with adjustable brightness",
    stock: 45
  },
  { 
    id: 2, 
    ...
    rating: 4.9, 
    reviews: 85, 
    image: "https://iili.io/37eGGup.webp",
    isFeatured: false,
    isNew: true,
    description: "16 million colors with app control",
    stock: 28
  },
  { 
    id: 3, 
    ...
    rating: 4.5, 
    reviews: 200, 
    image: "https://iili.io/37eG08v.webp",
    isFeatured: false,
    isNew: true,
    description: "Voice control compatible with Alexa & Google Home",
    stock: 12
  },
  { 
    id: 4, 
    ...
    rating: 4.5, 
    reviews: 200, 
    image: "https://iili.io/37eGcFa.webp",
    isFeatured: false,
    isNew: false,
    description: "Long-lasting with 25,000 hours lifespan",
    stock: 50
  },
  { 
    id: 5, 
    name: "Motion Sensor Bulb", 
    price: 350, 
    originalPrice: 500, 
    rating: 4.7, 
    reviews: 150, 
    ...
    isFeatured: false,
    isNew: false,
    description: "Automatic on/off with motion detection",
    stock: 32
  },
  { 
    id: 6, 
...
export default function HomeScreen() {
  ...
  const DealOfTheDay = () => (
    <View className="mx-4 mb-6 bg-gradient-to-r from-purple-500 to-indigo-600 p-4 rounded-2xl">
